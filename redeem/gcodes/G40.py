"""
GCode G40
Single Z probe (down stroke only, no up stroke)

Author: Eric Douglas
email: eric(at)ericdouglas dot us
...
class G40(GCodeCommand):
    ...
    def execute(self, g):
        ...
        bed_dist = self.printer.path_planner.xprobe(probe_length, probe_speed, probe_accel)*1000.0 # convert to mm
    ...
    def get_test_gcodes(self):
        return ["G40", "G40 P0", "G40 P1 X10 Y10"]
